...
export const CSSFlipbook: React.FC<CSSFlipbookProps> = ({
  ...
  const [flippingPageImage, setFlippingPageImage] = useState<[string, string] | null>(null);
  ...
  const goToNextSpread = useCallback(() => {
    if (!isFlipping && currentSpread < spreads.length - 1) {
      ...
      // Set both front and back images for 3D flip
      ...
      // Store both images for the dual-face approach
      setFlippingPageImage([frontImage, backImage]);
    ...
    <div className={`flipbook-wrapper ${isSafariBrowser ? 'safari-browser' : ''}`}>
      <div className="flipbook-container">
        ...
        >
          ...
          {isFlipping && flipDirection === 'back' && flippingPageImage && Array.isArray(flippingPageImage) && (
